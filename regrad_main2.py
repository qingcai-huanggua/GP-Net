...
def run():
    ...
    train_data = Regrad('/home/user/xyh_rl_projects/new_data', include_rgb=use_rgb, include_depth=use_depth,start=0.0,
    ...
    val_data = Regrad('/home/user/xyh_rl_projects/new_data', include_rgb=use_rgb, include_depth=use_depth, start=split,
    ...
    for epoch in range(epochs):
        ...
        # 添加IOU到tb
        tb.add_scalar('loss/IOU', float(validate_results['correct']) / (
